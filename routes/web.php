...
$router->group(['middleware' => 'jwt.auth'], function () use ($router)
{
    ...
    $router->post('get_list_role', ['uses' => 'Master\MasterUser@get_list_role']);
    $router->post('get_list_user_resp_by_role', ['uses' => 'Master\MasterUser@get_list_user_resp']);
    $router->post('get_list_username', ['uses' => 'Master\MasterUser@get_list_username']);
    ...
    $router->post('get_data_master_resp', ['uses' => 'Master\MasterResp@get_data_master_resp']);
    ...
    $router->post('get_data_master_company', ['uses' => 'Master\MasterCompany@get_data_master_company']);
